...
export default function Tab({activeTab, setActiveTab}) {
  ...
  return (
    <div className="scrolling-tabs">
          <div className={`tab ${activeTab === 'IECC' ? 'active' : ''}`} onClick={() => handleTabClick('IECC')} >
          ...
          <div className={`tab ${activeTab === 'Colleges' ? 'active' : ''}`} onClick={() => handleTabClick('Colleges')} >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#000000   " fill="none">
          ...
          <div className={`tab ${activeTab === 'Schools' ? 'active' : ''}`} onClick={() => handleTabClick('Schools')} >
          ...
          <div className={`tab ${activeTab === 'Students' ? 'active' : ''}`} onClick={() => handleTabClick('Students')} >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} color={"#000000  "} fill={"none"}>
          ...
          <div className={`tab ${activeTab === 'Company' ? 'active' : ''}`} onClick={() => handleTabClick('Company')} >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} fill={"none"}>
          ...
          <div className={`tab ${activeTab === 'Startup' ? 'active' : ''}`} onClick={() => handleTabClick('Startup')} >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"  fill={"none"}>
          ...
          <div className={`tab ${activeTab === 'Job' ? 'active' : ''}`} onClick={() => handleTabClick('Job')} >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="none">
