...
export default function Persontab({ activeTab, setActiveTab, uuid }) {
  ...
  return (
    <div className="scrolling-tabs">
      ...
      <div
        className={`tab ${activeTab === "Interlinks" ? "active" : ""}`}
        onClick={() => handleTabClick("Interlinks")}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
      ...
      <div
        className={`tab ${activeTab === "Infograph" ? "active" : ""}`}
      ...
      <div
        className={`tab ${activeTab === "M.O.M" ? "active" : ""}`}
        onClick={() => handleTabClick("M.O.M")}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
